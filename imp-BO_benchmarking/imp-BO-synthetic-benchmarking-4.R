...
# divide into chunks
synth_test_functions <- all_benchmark_funs[9]
...
save(results_list, file = paste(getwd(),"/imp-BO_benchmarking/results/results-imp-BO-tests-init-4-budget-40-n-40-fun9-drop-wave" ,sep=""))
