...
source("univariate-benchmark-functions/make-multimodal-sine-signal.R") 
...
save(results_list, file = paste(getwd(),"/imp-BO_benchmarking/results/results-imp-BO-sine-signal" ,sep=""))
