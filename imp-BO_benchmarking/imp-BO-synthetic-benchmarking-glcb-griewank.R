...
for (i in 1:1) {
  ...
  for (j in 1:n) {
    print(j)
        ...
        ## same design for all approaches in one run
...
save(results_list, file = paste(getwd(),"/imp-BO_benchmarking/results/results-imp-BO-synthetic-glcb-griewank" ,sep=""))
