...
# divide into chunks
synth_test_functions <- all_benchmark_funs[c(6:10)]
...
save(results_list, file = paste(getwd(),"/imp-BO_benchmarking/results/results-imp-BO-tests-init-10-budget-90-n-40-funs-6-10-glcb-only" ,sep=""))
