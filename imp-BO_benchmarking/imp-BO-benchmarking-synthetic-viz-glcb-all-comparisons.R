...
annotate_figure(pub_page,
                top = text_grob("GLCB vs. Classic Acquisition Functions (Drop Wave)", color = "black", face = "bold", size = 14),
                bottom = text_grob("Bayesian optimization of synthetic drop wave function
